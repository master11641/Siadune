...
class MovieCatalogBloc implements BlocBase {
  ...
  BehaviorSubject<List<int>> _releaseDatesController = BehaviorSubject<List<int>>.seeded([2000,2005]);
  ...
  ///
  BehaviorSubject<MovieFilters> _filtersController = BehaviorSubject<MovieFilters>.seeded(MovieFilters(genre: 28, minReleaseDate: 2000, maxReleaseDate: 2005));
