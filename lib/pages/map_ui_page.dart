...
import 'package:siadune/api/place_api.dart';
...
class MapUiBodyState extends State<MapUiBody> {
      ...
      onPressed: () {
        setState(() {
          _minMaxZoomPreference = _minMaxZoomPreference.minZoom == null
              ? const MinMaxZoomPreference(14.0, 16.0)
  ...
  Widget _visibleRegionGetter() {
    return FlatButton(
      ...
      onPressed: () async {
        //  var myresult = await mapController.getSymbolLatLng(sym);
  ...
  Widget build(BuildContext context) {
    ...
    final MapboxMap mapboxMap = MapboxMap(
        ...
        minMaxZoomPreference: MinMaxZoomPreference(14.0, 16.0),
        ...
        onMapClick: (point, latLng) async {
          ...
          PlaceResponse placeResponse =
              await getPlace(latLng.longitude, latLng.latitude);
          print(placeResponse.features[0].placeName);
